...
namespace Terraria.Initializers
{
  public class UILinksInitializer
  {
    ...
    private static bool CanEnterCreativeMenu() => Main.LocalPlayer.chest == -1 && Main.LocalPlayer.talkNPC == -1 && Main.playerInventory && Main.CreativeMenu.Enabled;

    private static int GetCornerWrapPageIdFromLeftToRight() => 8;

    private static int GetCornerWrapPageIdFromRightToLeft() => Main.CreativeMenu.Enabled ? 1005 : 10;
