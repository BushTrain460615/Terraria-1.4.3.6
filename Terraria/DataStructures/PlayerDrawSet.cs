  ...
  public struct PlayerDrawSet
  {
      ...
      Vector2 rotationOrigin)
    {
      ...
      if (!this.drawPlayer.isDisplayDollOrInanimate)
      {
        ...
        {
          float num30 = (float) ((double) Main.mouseTextColor / 200.0 - 0.300000011920929);
        ...
        {
          float num31 = (float) (0.600000023841858 - (double) this.drawPlayer.ghostFade * 0.300000011920929);
          if ((double) this.shadow != 0.0)
            num31 = 0.0f;
      ...
      if (this.drawPlayer.slowOgreSpit && Main.instance.IsActive && !Main.gamePaused)
      {
        ...
        if (Main.rand.Next(5) == 0 && (double) this.shadow == 0.0)
        {
          ...
          dust18.scale = (float) (0.800000011920929 + (double) Main.rand.NextFloat() * 0.600000023841858);
          dust18.fadeIn = 0.5f;
        ...
        for (int index1 = 0; index1 < 3; ++index1)
        {
          switch (index1)
          {
            case 0:
              ...
              {
                num33 = 6.283185f / (float) this.drawPlayer.nebulaLevelLife;
            ...
            case 1:
              ...
              {
                num33 = -6.283185f / (float) this.drawPlayer.nebulaLevelMana;
            ...
            case 2:
              ...
              {
                num33 = 6.283185f / (float) this.drawPlayer.nebulaLevelDamage;
            ...
            default:
              for (int index2 = 0; index2 < num35; ++index2)
              {
                ...
                dust19.position = this.drawPlayer.Center + Vector2.UnitY * this.drawPlayer.gfxOffY + ((float) ((double) num32 * 6.28318548202515 + (double) num33 * (double) index2)).ToRotationVector2() * num34;
