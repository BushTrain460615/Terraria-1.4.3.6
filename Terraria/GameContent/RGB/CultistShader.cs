  ...
  public class CultistShader : ChromaShader
  {
      ...
      float time)
    {
      ...
      for (int index = 0; index < fragment.Count; ++index)
      {
        ...
        float num = (float) (((double) d + 3.14159274101257) % 18.8495559692383);
        Vector4 vector4_1;
        if ((double) num < 6.28318548202515)
        {
