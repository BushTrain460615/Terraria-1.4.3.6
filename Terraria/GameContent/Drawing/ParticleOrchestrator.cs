...
namespace Terraria.GameContent.Drawing
{
  public class ParticleOrchestrator
  {
    ...
    private static void Spawn_PrincessWeapon(ParticleOrchestraSettings settings)
    {
      ...
      {
        Vector2 vector2_1 = settings.MovementVector * (float) (0.600000023841858 + (double) Main.rand.NextFloat() * 0.349999994039536);
        Vector2 vector2_2 = new Vector2((float) ((double) Main.rand.NextFloat() * 0.400000005960464 + 0.200000002980232));
        ...
        prettySparkleParticle1.ColorTint = Main.hslToRgb((float) ((0.920000016689301 + (double) Main.rand.NextFloat() * 0.0199999995529652) % 1.0), 1f, (float) (0.400000005960464 + (double) Main.rand.NextFloat() * 0.25));
      ...
      {
        Color rgb = Main.hslToRgb((float) ((0.920000016689301 + (double) Main.rand.NextFloat() * 0.0199999995529652) % 1.0), 1f, (float) (0.400000005960464 + (double) Main.rand.NextFloat() * 0.25));
