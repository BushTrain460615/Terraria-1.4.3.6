    ...
    public static void Draw(SpriteBatch spriteBatch)
    {
      ...
      for (int i = 0; i < LockOnHelper._drawProgress.GetLength(0); ++i)
      {
        ...
        if ((double) num11 > 0.0)
        {
          ...
          {
            float radians = (float) (6.28318548202515 / (double) num14 * (double) index + (double) Main.GlobalTimeWrappedHourly * 6.28318548202515 * 0.25);
            ...
            float rotation = (float) ((double) radians * ((double) gravDir == 1.0 ? 1.0 : -1.0) + 3.14159274101257 * ((double) gravDir == 1.0 ? 1.0 : 0.0));
