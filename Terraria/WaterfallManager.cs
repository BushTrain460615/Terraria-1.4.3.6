        ...
        for (int index5 = 0; index5 < num25; ++index5)
        {
          if (num24 < 2)
          {
            ...
            if (!tile.nactive() || !Main.tileSolid[(int) tile.type] || Main.tileSolidTop[(int) tile.type] || TileID.Sets.Platforms[(int) tile.type] || tile.blockType() != 0)
            {
              ...
              float r9 = (float) color5.R * num36;
              float g9 = (float) color5.G * num36;
              float b9 = (float) color5.B * num36;
              float a = (float) color5.A * num36;
              switch (index2)
              {
                case 1:
                  if ((double) r9 < 190.0 * (double) num36)
                    r9 = 190f * num36;
                  if ((double) g9 < 190.0 * (double) num36)
                    g9 = 190f * num36;
                  if ((double) b9 < 190.0 * (double) num36)
                  {
                    b9 = 190f * num36;
                    break;
                  }
                  break;
                case 2:
                  r9 = (float) Main.DiscoR * num36;
                  g9 = (float) Main.DiscoG * num36;
                  b9 = (float) Main.DiscoB * num36;
                  break;
                case 15:
                case 16:
                case 17:
                ...
                case 20:
                case 21:
                  r9 = (float) byte.MaxValue * num36;
                  g9 = (float) byte.MaxValue * num36;
                  b9 = (float) byte.MaxValue * num36;
                  break;
              }
              color5 = new Color((int) r9, (int) g9, (int) b9, (int) a);
              if (index2 == 1)
              {
                float num37 = Math.Abs((float) (x1 * 16 + 8) - (Main.screenPosition.X + (float) (Main.screenWidth / 2)));
                float num38 = Math.Abs((float) (y * 16 + 8) - (Main.screenPosition.Y + (float) (Main.screenHeight / 2)));
              ...
              {
                float num40 = Math.Abs((float) (x1 * 16 + 8) - (Main.screenPosition.X + (float) (Main.screenWidth / 2)));
                float num41 = Math.Abs((float) (y * 16 + 8) - (Main.screenPosition.Y + (float) (Main.screenHeight / 2)));
                if ((double) num40 < (double) (Main.screenWidth * 2) && (double) num41 < (double) (Main.screenHeight * 2))
                {
                  float num42 = (float) (1.0 - Math.Sqrt((double) num40 * (double) num40 + (double) num41 * (double) num41) / ((double) Main.screenWidth * 0.75));
                  if ((double) num42 > 0.0)
                    num1 += num42;
                }
                if ((double) num40 < (double) num2)
                {
                  num2 = num40;
                  num4 = x1 * 16 + 8;
                }
                if ((double) num41 < (double) num3)
                {
                  num3 = num40;
                  num5 = y * 16 + 8;
                }
              ...
              {
                float num43 = (float) color6.R;
                if ((double) color6.G > (double) num43)
                  num43 = (float) color6.G;
                if ((double) color6.B > (double) num43)
                  num43 = (float) color6.B;
                if ((double) Main.rand.Next(20000) < (double) num43 / 30.0)
                {
                    ...
                    if (Main.tile[x1, y].liquid <= (byte) 0 || Main.tile[x1, y].halfBrick())
                    {
                      if (num31 == -1)
                      {
                        for (int index7 = 0; index7 < 8; ++index7)
                        {
                          int num44 = index7 * 2;
                          int num45 = index7 * 2;
                          int num46 = 14 - index7 * 2;
                          num11 = 8;
                          if (num12 == 0 && index7 > 5)
                            num46 = 4;
                          spriteBatch.Draw(this.waterfallTexture[index2].Value, new Vector2((float) (x1 * 16 + num44), (float) (y * 16 + num11 + num46)) - Main.screenPosition, new Rectangle?(new Rectangle(16 + x2 + num45, 0, 2, 16 - num11)), color5, 0.0f, new Vector2(), 1f, SpriteEffects.FlipHorizontally, 0.0f);
                        }
                        break;
                      }
                      int height = 16;
                  ...
                  case 1:
                    if (Main.tile[x1, y].liquid <= (byte) 0 || Main.tile[x1, y].halfBrick())
                    {
                      if (num31 == 1)
                      {
                        ...
                        {
                          int num47 = index8 * 2;
                          int num48 = 14 - index8 * 2;
                          int num49 = num47;
                          num11 = 8;
                          if (num12 == 0 && index8 < 2)
                            num49 = 4;
                          spriteBatch.Draw(this.waterfallTexture[index2].Value, new Vector2((float) (x1 * 16 + num47), (float) (y * 16 + num11 + num49)) - Main.screenPosition, new Rectangle?(new Rectangle(16 + x2 + num48, 0, 2, 16 - num11)), color5, 0.0f, new Vector2(), 1f, SpriteEffects.FlipHorizontally, 0.0f);
                        }
                        break;
                      }
                      int height = 16;
