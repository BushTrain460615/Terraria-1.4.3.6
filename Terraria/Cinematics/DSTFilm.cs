...
namespace Terraria.Cinematics
{
  public class DSTFilm : Film
  {
    ...
    private void PrepareScene()
    {
      ...
      Main.time = 13500.0;
      Main.time = 43638.0;
      Main.windSpeedCurrent = Main.windSpeedTarget = 0.368f;
      Main.windCounter = 2011;
      Main.cloudAlpha = 0.0f;
      Main.raining = true;
      Main.rainTime = 3600;
      double num1;
      Main.cloudAlpha = (float) (num1 = 0.899999976158142);
      Main.oldMaxRaining = (float) num1;
      Main.maxRaining = (float) num1;
      Main.raining = true;
      double num2;
      Main.cloudAlpha = (float) (num2 = 0.600000023841858);
      Main.oldMaxRaining = (float) num2;
      Main.maxRaining = (float) num2;
      Main.raining = true;
      double num3;
      Main.cloudAlpha = (float) (num3 = 0.600000023841858);
